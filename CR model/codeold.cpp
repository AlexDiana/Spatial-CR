...
// // [[Rcpp::export]]
// bool checkPointIsInRegionNew(arma::vec x){
//   
//   // outside of boundaries
//   if(x(0) < -2.4 | x(0) > 2.2 | x(1) < -2.65 | x(1) > 2.65){
//     return(false);
//   }
//   
//   if(x(0) > -2.4 & x(0) < -1.3 & x(1) > .5 & x(1) < 2.65){ //  triangle upper left
//     
//     if(x(1) < 1.954545 * x(0) + 5.190909){
//       return(true);
//     } else {
//       return(false);
//     }
...
//   }
//   
//   if(x(0) < .85 & x(0) > -2.4 & x(1) < .5 & x(1) > -2.65){ // triangle lower left
//     
//     if(x(1) > -0.9692308 * x(0) -1.826154){
//       return(true);
//     } else {
//       return(false);
//     }
...
//   }
//   
//   if(x(0) > .85 & x(0) < 2.2 & x(1) > -2.65 & x(1) < -1.35){ // triangle lower right
//     
//     if(x(1) > 2.952381 * x(0)  -5.159524){
//       return(true);
//     } else {
//       return(false);
//     }
...
//   }
//   
//   if(x(0) > 1.8 & x(0) < 2.2 & x(1) > -1.35 & x(1) < .6){ // small triangle upper right
//     
//     if(x(1) < -4.875 * x(0) + 9.375){
//       return(true);
//     } else {
//       return(false);
//     }
...
//   }
//   
//   if(x(0) > -1.3 & x(0) < 1.8 & x(1) > .6 & x(1) < 2.65){ // triangle above
//     
//     if(x(1) < -0.6612903 * x(0) + 1.790323){
//       return(true);
//     } else {
//       return(false);
//     }
...
// [[Rcpp::export]]
bool checkPointIsInRegionTrapsPolygons(arma::vec point, 
                                       NumericMatrix coord, 
...
// [[Rcpp::export]]
arma::vec proposeNewPoint(double a1, double b1, double a2, double b2, arma::mat traps, double R){
...
// [[Rcpp::export]]
arma::vec proposeNewPointMixture(double probMixture, arma::mat mixtureMeans, arma::mat mixtureSd, 
...
List simulate_bivsoftcore_cpp(double theta1, double theta2, double theta3,
  ...
  for(int i = 0; i < N1; i++){
    data1.row(i) = arma::conv_to<arma::rowvec>::from(proposeNewPoint(a1, b1, a2, b2, traps, R));
  }
...
// [[Rcpp::export]]
double loglikelihood_p_cpp2(double p0, double sigma,
                            arma::mat CH, arma::mat s_n, 
                            arma::vec trapsX, arma::vec trapsY,
                            arma::vec S_usage, int N){
...
arma::vec update_psigma_cpp(double p0, 
  ...
  if(p_new > 0 & p_new < 1){
    ...
    double loglikelihood_p0_star = loglikelihood_p_cpp2(p_new, sigma, CH, s,
                                                        trapsX, trapsY, S_usage, N);
    
    double loglikelihood_p0 = loglikelihood_p_cpp2(p0, sigma, CH, s,
                                                   trapsX, trapsY, S_usage, N);
  ...
  if(sigma_star > 0){
    ...
    double loglikelihood_sigma_star = loglikelihood_p_cpp2(p0, sigma_star, CH, s,
                                                           trapsX, trapsY, S_usage, N);
    
    double loglikelihood_sigma = loglikelihood_p_cpp2(p0, sigma, CH, s,
                                                      trapsX, trapsY, S_usage, N);
...
List update_s_cpp(arma::mat s1, arma::mat s2, 
  ...
  if(R::runif(0,1) < q){
    ...
    if(R::runif(0,1) < p){
      ...
      arma::vec x1_new = proposeNewPoint(a1, b1, a2, b2, traps, R);
  ...
  if(R::runif(0,1) < q){
    ...
    if(R::runif(0,1) < p){
      ...
      arma::vec x2_new = proposeNewPoint(a1, b1, a2, b2, traps, R);
...
// [[Rcpp::export]]
List update_s_cpp_newproposal_notused(arma::mat s1, arma::mat s2, 
                                      double theta1, double theta2, double theta3, 
                                      double beta1, double beta2, 
                                      arma::mat CH1, arma::mat CH2,
                                      int N1, int N2, int D1, int D2,
                                      ...
                                      arma::vec S_usage, arma::vec trapsX, arma::vec trapsY,
                                      arma::mat Sigma_prop, arma::mat Sigma_newpoint,
                                      double probMixture1, double probMixture2,
                                      arma::vec mixtureMeans1, arma::vec mixtureMeans2, 
                                      arma::vec mixtureSd1, arma::vec mixtureSd2, 
                                      arma::vec normConst1, arma::vec normConst2,
                                      arma::mat traps, double R,
                                      double a1, double b1, double a2, double b2){
  ...
  if(R::runif(0,1) < q){
    ...
    if(R::runif(0,1) < p){
      ...
      arma::vec x1_new = proposeNewPointMixture(probMixture1, mixtureMeans1, mixtureSd1, 
                                                a1, b1, a2, b2,
                                                traps, R);
      ...
      double birthDensity = probProposingIndividual(x1_new, probMixture1,
                                                    a1, b1, a2, b2,
                                                    mixtureMeans1, mixtureSd1, normConst1);
      
      double logposterior_xistar = log_hastings_ratio_num + loglikelihood_xi_star;
      double logposterior_xi = log_hastings_ratio_den;
      
      double log_numerator = logposterior_xistar;
      double log_denominator = logposterior_xi + log(birthDensity);
      ...
      if(N1 > D1){
        ...
        double birthDensity = probProposingIndividual(xi, probMixture1,
                                                      a1, b1, a2, b2,
                                                      mixtureMeans1, mixtureSd1, normConst1);
        
        double log_numerator = logposterior_xistar + log(birthDensity);
        double log_denominator = logposterior_xi;
  ...
  if(R::runif(0,1) < q){
    ...
    if(R::runif(0,1) < p){
      ...
      arma::vec x2_new = proposeNewPointMixture(probMixture2, mixtureMeans2, mixtureSd2, 
                                                a1, b1, a2, b2,
                                                traps, R);
      ...
      double birthDensity = probProposingIndividual(x2_new, probMixture2,
                                                    a1, b1, a2, b2,
                                                    mixtureMeans2, mixtureSd2, normConst2);
      ...
      if(R::runif(0,1) < exp(log_numerator - log_denominator)){
        log_hastings_ratio_den = log_hastings_ratio_num;
        s2.row(N2) = arma::conv_to<arma::rowvec>::from(x2_new);
        N2 += 1;
        isPoint2Accepted = false;
        acceptedPoint2 = x2_new;
      }
      ...
      if(N2 > D2){
        ...
        double birthDensity = probProposingIndividual(xi, probMixture2,
                                                      a1, b1, a2, b2,
                                                      mixtureMeans2, mixtureSd2, normConst2);
...
// [[Rcpp::export]]
List update_s_cpp_poisson(arma::mat s1, arma::mat s2,
  ...
  if(R::runif(0,1) < q){
    ...
    if(R::runif(0,1) < p){
      ...
      int pointsToPropose = 1 +  R::rpois(lambda_newPoints1);
      ...
      double log_hastings_ratio_num = log_f_bivsoftcore_cpp_quick_addition(x_new, pointsToPropose,
                                                                           s1, s2, N1, N2,
      ...
      for(int l = 0; l < pointsToPropose; l++){
        arma::vec x_current = arma::conv_to<arma::vec>::from(x_new.row(l));
        loglikelihood_xi_star += log(probAcceptingIndividual(s1, x_current, p0_1, sigma_1, D1, N1 + l,
                                                             K, S_usage, trapsX, trapsY));
      }
      ...
      // compute proposals ratio
      double logProposalRatio = 0;
      for(int l = 0; l < pointsToPropose; l++){
        arma::vec x1_new = arma::conv_to<arma::vec>::from(x_new.row(l));
        logProposalRatio += 0;//log(densProposal(x1_new, constUnif));
      }
      
      double log_numerator = logposterior_xistar;
      double log_denominator = logposterior_xi + logProposalRatio;
      ...
      int pointsToRemove = 1 +  R::rpois(lambda_newPoints1);
      ...
      if(N1 - pointsToRemove >= D1){
        ...
        double log_hastings_ratio_num = log_f_bivsoftcore_cpp_quick_removal(idxPointsToRemove, pointsToRemove,
                                                                            s1, s2, N1, N2,
                                                                            beta1, theta1, theta12);
        ...
        for(int l = 0; l < pointsToRemove; l++){
          ...
          loglikelihood_xi_star += log(probAcceptingIndividual(s1, xi, p0_1, sigma_1, D1, N1 - l - 1,
                                                               K, S_usage, trapsX, trapsY));
        ...
        double logProposalRatio = 0;
        for(int l = 0; l < pointsToRemove; l++){
          arma::vec x1_new = arma::conv_to<arma::vec>::from(s1.row(idxPointsToRemove[l]));
          logProposalRatio += 0;//log(densProposal(x1_new, constUnif));
        }
        
        double log_numerator = logposterior_xistar + logProposalRatio;
        double log_denominator = logposterior_xi;
  ...
  if(R::runif(0,1) < q){
    ...
    if(R::runif(0,1) < p){
      ...
      int pointsToPropose = 1 +  R::rpois(lambda_newPoints2);
      
      arma::mat x_new = arma::zeros(pointsToPropose, 2);
      for(int l = 0; l < pointsToPropose; l++){
        arma::vec x2_new = proposeNewPoint(a1, b1, a2, b2, traps, R);
        x_new.row(l) = arma::conv_to<arma::rowvec>::from(x2_new);
      }
      ...
      for(int l = 0; l < pointsToPropose; l++){
        arma::vec x_current = arma::conv_to<arma::vec>::from(x_new.row(l));
        loglikelihood_xi_star += log(probAcceptingIndividual(s2, x_current, p0_2, sigma_2, D2, N2 + l,
                                                             K, S_usage, trapsX, trapsY));
      }
      ...
      int pointsToRemove = 1 +  R::rpois(lambda_newPoints2);
      
      if(N2 - pointsToRemove >= D2){
        
        IntegerVector seqN2D2 = seq(1, N2 - D2);
        
        IntegerVector idxPointsToRemove = D2 - 1 + RcppArmadillo::sample(seqN2D2, pointsToRemove, 0);
        ...
        for(int l = 0; l < pointsToRemove; l++){
          ...
          arma::vec xi = arma::conv_to<arma::vec>::from(s2.row(idxPointsToRemove[l]));
          
          loglikelihood_xi_star += log(probAcceptingIndividual(s2, xi, p0_2, sigma_2, D2, N2 - l - 1,
                                                               K, S_usage, trapsX, trapsY));
        ...
        double logProposalRatio = 0;
        for(int l = 0; l < pointsToRemove; l++){
          arma::vec x1_new = arma::conv_to<arma::vec>::from(s2.row(idxPointsToRemove[l]));
          logProposalRatio += 0;//log(densProposal(x1_new, constUnif));
        }
        ...
        if(R::runif(0,1) < exp(log_numerator - log_denominator)){
          ...
          for(int l = 0; l < pointsToRemove; l++){
            s2.row(idxPointsToRemove[l]) = s2.row(N2 - 1);
            N2 -= 1;
          }
...
// [[Rcpp::export]]
List update_s_cpp_poisson_proposal(arma::mat s1, arma::mat s2,
                                   double theta1, double theta2, double theta12,
                                   double beta1, double beta2,
                                   arma::mat CH1, arma::mat CH2,
                                   int N1, int N2, int D1, int D2,
                                   ...
                                   double lambda_newPoints1, double lambda_newPoints2,
                                   double probMixture1, double probMixture2,
                                   arma::mat mixtureMeans1, arma::mat mixtureMeans2, 
                                   arma::mat mixtureSd1, arma::mat mixtureSd2, 
                                   arma::vec normConst1, arma::vec normConst2,
                                   arma::mat traps, double R,
                                   double a1, double b1, double a2, double b2){
  ...
  if(R::runif(0,1) < q){
    ...
    if(R::runif(0,1) < p){
      ...
      int pointsToPropose = 1 +  R::rpois(lambda_newPoints1);
      // Rcout << pointsToPropose << std::endl;
      arma::mat x_new = arma::zeros(pointsToPropose, 2);
      for(int l = 0; l < pointsToPropose; l++){
        arma::vec x1_new = proposeNewPointMixture(probMixture1, mixtureMeans1, mixtureSd1, 
                                                  a1, b1, a2, b2,
      ...
      for(int l = 0; l < pointsToPropose; l++){
        arma::vec x1_new = arma::conv_to<arma::vec>::from(x_new.row(l));
        logbirthDensity += log(probProposingIndividual(x1_new, probMixture1,
                                                       a1, b1, a2, b2,
                                                       mixtureMeans1, mixtureSd1, normConst1));
      }
      
      double log_numerator = logposterior_xistar;
      double log_denominator = logposterior_xi + logbirthDensity;
      ...
      if(N1 - pointsToRemove >= D1){
        ...
        double log_numerator = logposterior_xistar + logbirthDensity;
        double log_denominator = logposterior_xi;
  ...
  if(R::runif(0,1) < q){
    ...
    if(R::runif(0,1) < p){
      ...
      for(int l = 0; l < pointsToPropose; l++){
        arma::vec x1_new = arma::conv_to<arma::vec>::from(x_new.row(l));
        logbirthDensity += log(probProposingIndividual(x1_new, probMixture2,
                                                       a1, b1, a2, b2,
                                                       mixtureMeans2, mixtureSd2, normConst2));
      }
...
double computePointsAdditionRatio(arma::mat x_new, int ptsToPropose, int N, int N2,
  ...
  Rcout << logRatio_f << " - " << loglikelihood_xi_star << " - " << logDeathDensity <<  " - " << logbirthDensity << std::endl;
...
void ProposePointProcess(arma::mat& s1, arma::mat& s2,
                         ...
                         arma::mat Sigma_prop, arma::mat Sigma_newpoint,
                         double lambda_movedPoints, double lambda_newPoints, double probMixture, 
                         arma::mat mixtureMeans, arma::mat mixtureSd, arma::vec normConst,
                         double R, double S_area, arma::vec S_usage, 
                         arma::mat traps, arma::vec trapsX, arma::vec trapsY,
                         double a1, double b1, double a2, double b2,
    ...
    if(R::runif(0,1) < p){
      ...
      if(N1 - pointsToRemove >= D1){
        ...
        double mh_ratio = computePointsDeletionRatio(idxPointsToRemove, pointsToRemove, N1, N2,
                                                     s1, s2, beta, theta1, theta12, probMixture,
                                                     mixtureMeans, mixtureSd, normConst, 
                                                     a1, b1, a2, b2, S_area,
                                                     D1, K, p0, sigma,
                                                     S_usage, trapsX, trapsY);
...
// [[Rcpp::export]]
List update_s_cpp_new(arma::mat s1, arma::mat s2,
                      double theta1, double theta2, double theta12,
                      double beta1, double beta2,
                      arma::mat CH1, arma::mat CH2,
                      int N1, int N2, int D1, int D2,
  ...
  ProposePointProcess(s1, s2, theta1, theta2, theta12,
                      ...
                      probMixture1, mixtureMeans1, 
                      mixtureSd1, normConst1, 
                      R, S_area, S_usage, traps, trapsX, trapsY, 
                      a1, b1, a2, b2,
                      q, p, mh_ratio);
  ...
  ProposePointProcess(s2, s1, theta2, theta1, theta12,
                      ...
                      probMixture2, mixtureMeans2, 
                      mixtureSd2, normConst2, 
                      R, S_area, S_usage, traps, trapsX, trapsY, 
                      a1, b1, a2, b2,
                      q, p, mh_ratio);
...
// [[Rcpp::export]]
List update_N_cpp_new(arma::mat s1, arma::mat s2,
                      double theta1, double theta2, double theta12,
                      double beta1, double beta2,
                      arma::mat CH1, arma::mat CH2,
                      int N1, int N2, int D1, int D2,
