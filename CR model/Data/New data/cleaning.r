...
traps <- read.csv(file = "trapnew.csv")
tiger <- read.csv(file = "tig.csv")
leopards <- read.csv(file = "leop.csv")
...
save(CH_leopards, CH_tigers, traps, S_usage, file = "JimCorbettData.rda")
