...
// [[Rcpp::export]]
arma::vec proposeNewPoint(double a1, double b1, double a2, double b2, 
  ...
  while(!checkPointIsInRegionPolygonsAndTraps(proposedPoint, polycoord, 
                                              polygonHole, polygonStarts, traps, R)){
  // while(!checkPointIsInRegionPolygons(proposedPoint, polycoord, 
...
arma::vec proposeNewPointMixture(double probMixture, arma::mat mixtureMeans, arma::mat mixtureSd, 
  ...
  if(R::runif(0,1) < (1 - probMixture)){
    ...
    proposedPoint = proposeNewPoint(polyBoundaries[0], 
                                    polyBoundaries[1], 
                                                  polyBoundaries[2], 
                                                                polyBoundaries[3], 
                                                                              polycoord, 
...
List simulate_bivsoftcore_cpp(double theta1, double theta2, double theta3,
  ...
  for(int i = 0; i < N1; i++){
    data1.row(i) = arma::conv_to<arma::rowvec>::from(proposeNewPoint(polyBoundaries1[0], 
                                                                     polyBoundaries1[1], 
                                                                     polyBoundaries1[2], 
                                                                     polyBoundaries1[3], 
                                                                     polycoord1, 
  ...
  for(int i = 0; i < N2; i++){
    data2.row(i) = arma::conv_to<arma::rowvec>::from(proposeNewPoint(polyBoundaries2[0], 
                                                                     polyBoundaries2[1], 
                                                                     polyBoundaries2[2], 
                                                                              polyBoundaries2[3], 
                                                                                    polycoord2, 
  ...
  for(int iter = 0; iter < niter; iter++){
    ...
    if(R::runif(0,1) < q){
      ...
      if(R::runif(0,1) < p){
        ...
        arma::vec xi = proposeNewPoint(polyBoundaries1[0], 
                                       polyBoundaries1[1], 
                                                      polyBoundaries1[2], 
                                                                     polyBoundaries1[3], 
                                                                                    polycoord1, 
    ...
    if(R::runif(0,1) < q){ 
      ...
      if(R::runif(0,1) < p){
        ...
        arma::vec xi = proposeNewPoint(polyBoundaries2[0], 
                                       polyBoundaries2[1], 
                                                      polyBoundaries2[2], 
                                                                     polyBoundaries2[3], 
                                                                                    polycoord2, 
...
void ProposePointProcess(arma::mat& s1, arma::mat& s2,
  ...
  if(R::runif(0,1) < q){
    ...
    for(int j = 0; j < pointsToMove; j++) {
      ...
      if(checkPointIsInRegionPolygonsAndTraps(xi, polycoord, 
                                              polygonHole, polygonStarts, 
                                              traps, R)){
    ...
    if(R::runif(0,1) < p){
      ...
      double mh_ratio = computePointsAdditionRatio(x_new, pointsToPropose, N1, N2,
                                                   ...
                                                   mixtureSd, normConst, 
                                                   polyBoundaries[0], polyBoundaries[1], 
                                                   polyBoundaries[2], polyBoundaries[3], 
                                                   S_area,
                                                   D1, K, p0, sigma,
